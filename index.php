		...
		<div class="container">
			...
			<div class="main-container portfolio-inner clearfix">
				...
				<div class="portfolio-div">
					<div class="portfolio">
						<br /><br />
					    <form name="frmEventSearch"  action="scripts/search.php" method="post" onsubmit="return SearchEvents()">
					      <input type="text" placeholder="Search.." name="search" class="form-input" id="search" required>
								<input type="submit" name="submit" id="btnSearchEvents" value="Search"/>
					    </form>
						<!-- portfolio_container -->
		...
		function SearchEvents(){
			...
			var searching = {
				...
				$.ajax({
							type: "POST",
							dataType: "json",
							url: "scripts/search.php", //Relative or absolute path to response.php file
							data: searching,
